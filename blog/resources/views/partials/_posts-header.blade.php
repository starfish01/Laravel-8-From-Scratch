<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-4">
        <!--  Category -->
        <div class="relative bg-gray-100 rounded-xl lg:inline-flex items-center">
            ...
            <x-dropdown>
                ...
                @foreach($categories as $category)
                    <x-dropdown-item :active="isset($currentCategory) && $currentCategory->is($category)" href="/categories/{{$category->slug}}">{{$category->name}}</x-dropdown-item>
                @endforeach
            </x-dropdown>
